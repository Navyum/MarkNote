...
const data: BaseLanguage = {
  ...
  'external-file-readonly': {
    'readonly-desc': 'Внешние файлы по умолчанию доступны только для чтения. Вы можете [включить редактирование этого внешнего файла](%s) или [изменить настройки только для чтения внешних файлов](%s).',
  ...
  'setting-panel': {
    ...
    'schema': {
      ...
      'editor': {
        ...
        'external-file-readonly': 'Внешние файлы только для чтения по умолчанию',
      },
      'render': {

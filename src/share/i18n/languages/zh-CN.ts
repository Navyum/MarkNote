...
const data: BaseLanguage = {
  ...
  'external-file-readonly': {
    'readonly-desc': '外部文件默认只读。可以[开启当前外部文档编辑](%s)或[修改外部文件只读设置](%s)。',
    'enable-edit': '开启当前外部文档编辑',
    'open-setting': '修改外部文件只读设置',
  },
  ...
  'premium': {
    ...
    'intro': {
      ...
      'current-plan': '当前版本',
      'included': '已包含',
      'desc': 'Mark Note 是一款开源笔记应用，从 2018 年开始，一直在不断开发和更新。因为软件的开发和维护需要精力和资金，现推出付费高级版。如果你想支持我的开发工作，或需要使用高级版功能，可以选择购买高级版。',
      'free-desc': '满足大部分用户需求',
      'premium-desc': '更多高级功能',
      'free-list': '基础编辑功能\n图形嵌入\n运行代码片段\nHTML 小工具\n文档加密\n内置终端\n文档历史\n插件扩展',
      'premium-list': '基础编辑功能\n图形嵌入\n运行代码片段\nHTML 小工具\n文档加密\n内置终端\n文档历史 (增强)\n插件扩展 (更多)\n宏替换\n暗色主题',
    ...
    'activation': {
      ...
      'tips-wechat': '微信',
      'activation-tips': '激活前请确保您的网络可以正常访问到 <a href="https://mark-note.com" target="_blank">https://mark-note.com</a>',
  ...
  'command-desc': {
    ...
    'layout_toggle-content-right-side': '显示/隐藏内容右侧栏',
